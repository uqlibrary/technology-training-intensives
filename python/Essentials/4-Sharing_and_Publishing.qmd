...
I you are using Positron, you should be able to use Quarto straight away as it comes bundles with it.
...
Once that is installed, Quarto should be bale to render a PDF.
