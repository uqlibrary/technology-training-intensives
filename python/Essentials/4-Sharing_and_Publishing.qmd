...
We've recently moved our intensives to the Positron IDE, but some instructions on this page may still reflect old steps. We're working to update them as fast as we can!
...
With [Positron](https://positron.posit.co/), our recommended IDE, Quarto is **already installed**.

:::{.callout-note}
# If you **are not** using Positron

If you aren't using Positron, you'll need to install Quarto yourself.

:::{.panel-tabset}
# Anaconda / Spyder 6.0 users
If you have Anaconda, you can install Quarto from its channels:
...
4. Restart the your terminal / Spyder kernel and type 
...
# Direct installation (Non-Anaconda / Spyder < v6 users)
If you're not using Anaconda, its simplest just to download and install Quarto [from their website](https://quarto.org/docs/get-started/)
