...
For simple (or complex) reshaping tasks, like filtering, subsetting and adding new columns, refresh yourself with our second session of this intensive: [2 - Data Processing](./Essentials/2-Data_processing.qmd). Alternatively, read one of the following user guides:
<!-- 
