...
Spend five minutes locating your data and preparing your project in Positron:
...
2. (Optional) Turn it into a project
    * Click *Folder Selector* (top right) $\rightarrow$ *Open Folder...* and choose the ***top-level folder*** of your project
...
* When you run R in Positron, it's the address displayed at the top of your **Console**
:::
...
* [R and Positron cheatsheets](https://posit.co/resources/cheatsheets/) are fantastic resources which outline the common data tidying tasks along with diagrams of the tabular operations. **Consult these often!**
