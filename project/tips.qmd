...
Here's a few general tips. In addition, we strongly recommend using [from Data to Viz](https://www.data-to-viz.com/), which guides you through choosing a visualisation, some caveats with various visualisation types, and examples in both Python and R.

For language-specific tips:

* Python: the [pandas cheatsheets](https://pandas.pydata.org/Pandas_Cheat_Sheet.pdf) gives a quick and easy reference for common packages and functions
* R: Posit compiles [cheatsheets about different packages](https://rstudio.github.io/cheatsheets/contributed-cheatsheets.html), notably for the Tidyverse.
...
| --- | --- | --- |
|  | <kbd>Ctrl</kbd>+<kbd>Enter</kbd> | Run current command (when in Script) |
| `<-` | <kbd>Alt</kbd>+<kbd>-</kbd> | Assignment operator (in R scripts) |
| `|>` | <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>M</kbd> | Pipe (in R scripts) |
