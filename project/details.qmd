...
See the [datasets](scaffold.qmd) page for the data and [below](#submission) for submission details.
...
| Wednesday morning | More exploratory analysis, start making visualisations, we will check in with you to see what your plans are |
| Wednesday afternoon | Prepare format, continue analysing and creating visualisation. |
| Thursday morning | Polish up results and finalise report, submit. |
...
2. Create a fork of our [python-training-intensive](https://github.com/camwest5/python-training-intensive) repository. This is a copy of the repo in your account, changes *will not automatically affect the main repo*. **Leave all settings unchanged**.
