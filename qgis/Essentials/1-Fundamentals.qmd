...
You can also use the `Project Home` directory in the browser to add another layer: try loading the "Project_Area.gpkg" and "Proposed_Access_Track.gpkg" GeoPackages (format .gpkg), by drag-and-dropping or double-clicking.
