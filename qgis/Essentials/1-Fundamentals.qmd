...
The **data** for this session can be directly downloaded from [this link](https://github.com/uqlibrary/technology-training-assets/raw/master/QGIS/intensives/QGIS_Intensive_Data.zip).
...
To add our own data: 
-   Go to the menu `Layer > Add Layer > Add Vector Layer...` 
-   Open your folders `data > raw > 1-fundamentals_data`
-   Choose the "Turbine_Locations_SEQ.gpkg" file, and click "Add". It is now in your `Layers` panel.
...
-   Click the `Project Home` dropdown, then `data > raw > 1-fundamentals_data`
-   Try loading the "Project_Area.gpkg" and "Proposed_Access_Track.gpkg" GeoPackages (format .gpkg), by drag-and-dropping or double-clicking.
