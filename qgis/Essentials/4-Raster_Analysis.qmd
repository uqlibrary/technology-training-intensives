...
We can also use our DEM to calculate how for away the wind turbines will be visible
...
If you want to know what can be seen from a certain point in a landscape, or where in the landscape can see a certain point, you can use a DEM to perform a Viewshed Analysis.
