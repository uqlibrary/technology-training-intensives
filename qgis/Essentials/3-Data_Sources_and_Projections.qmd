...
-   **GCS - Geographic Coordinate Systems**: They tell you *where* something is on earth. They are spherical models and are usually measured in angular degrees along lines of latitude and longitude. The earth is a complex changing shape (for example plate tectonics), so there are different GCSs for different places.
...
**EPSG:7844 – GDA 2020** (Geocentric Datum of Australia 2020) is Australia's national coordinate system, and provides more accurate positioning, as it takes into account more localised factors rather than being generically suitable for the whole world.
...
-   sa1_2021_bris_gda2020.gpkg (suburb data from the [Australian Bureau of Statistics](https://www.abs.gov.au/statistics/standards/australian-statistical-geography-standard-asgs-edition-3/jul2021-jun2026/access-and-downloads/digital-boundary-files))
...
You can now see the joined data highlighted in green in the ![Fields Tab Button](https://docs.qgis.org/3.40/en/_images/mSourceFields.png)`Fields` tab, click "OK", and check the actual values in the `SA1 Bris` layer's attribute table.
  ...
  - SA1 Boundaries (joined to SA1 Demographics)


## Subset our SA1 Data down to closer suburbs - Select features using an expression
