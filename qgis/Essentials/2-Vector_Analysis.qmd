...
-   Select the new **Access Track** layer and then click the **Toggle Editing** pencil ![Toggle Editing Button](https://docs.qgis.org/3.40/en/_images/mActionToggleEditing.png) from the top menu (or go to `Layer > Toggle Edititng`
