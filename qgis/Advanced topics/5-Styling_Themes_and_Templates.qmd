...
-   Navigate to `Settings > Style Manager...`
    ...
    -   Click the ![](images/symbologyAdd.png) `Add item` button at the bottom and select `Catalog: cpt-city...`
...
-   Click the new **Simple Fill**
    ...
    -   Scroll to the bottom, tick `Draw Effects`, then click the ![](images/mIconPaintEffects.png) `Customise effects` button (The one next to "Enable symbol layer", *not* the one in the "Layer Rendering" section!)
        -   Untick `Source`
