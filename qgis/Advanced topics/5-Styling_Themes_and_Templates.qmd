...
-   Clearance_area.kml (a dissolved buffer of the area that will need to be cleared for construction)

## Aims for this session

We've been sent through the proposed clearing distance around the construction areas, as well as the data from the cultural heritage survey. We want to put this map into a report.

We need to use our spatial files to make a map that:

-   Shows the project outline

-   Shows the clearance area

-   Show the access tracks
