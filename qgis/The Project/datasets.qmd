...
- Try [**Extract by Mask**](https://docs.qgis.org/latest/en/docs/user_manual/processing_algs/gdal/rasterextraction.html) to isolate high‑risk zones.
:::
...
- Try [**Spatial Join**](https://docs.qgis.org/latest/en/docs/user_manual/working_with_vector/joins_relations.html) to attach population counts to land use zones.
...
- Try [**Line Density**](https://docs.qgis.org/latest/en/docs/user_manual/processing_algs/qgis/interpolation.html#line-density) on footpaths to find heavily exposed walking routes.
:::
...
- Try [**Proximity (Distance to Nearest Hub)**](https://docs.qgis.org/latest/en/docs/user_manual/processing_algs/qgis/vectoranalysis.html#distance-to-nearest-hub-line-to-hub) to measure distance to roads or towns.
:::
...
- Try **Multi‑criteria Evaluation** with reclassified rasters. See for example [this tutorial](https://www.qgistutorials.com/en/docs/3/multi_criteria_overlay.html).
:::
...
- Use [**Kernel Density Estimation**](https://docs.qgis.org/latest/en/docs/user_manual/processing_algs/qgis/interpolation.html#heatmap-kernel-density-estimation) for smoother patterns.  
...
- Use [**Spatial Join**](https://docs.qgis.org/latest/en/docs/user_manual/working_with_vector/joins_relations.html) to link observations to areas.  
- Try [**Point Density**](https://docs.qgis.org/latest/en/docs/user_manual/processing_algs/qgis/interpolation.html#heatmap-kernel-density-estimation) to highlight hotspots.
:::
...
- Use the [**Raster Calculator to reclassify**](https://docs.qgis.org/latest/en/docs/training_manual/rasters/terrain_analysis.html#follow-along-reclassifying-the-raster) and combine environmental predictors into a single sensitivity surface.
...
- Explore [**Proximity (Raster Distance)**](https://docs.qgis.org/latest/en/docs/user_manual/processing_algs/gdal/rasteranalysis.html#proximity-raster-distance) as an input to a simple predictive model.  
:::
...
- Explore [**Viewshed**](https://docs.qgis.org/latest/en/docs/user_manual/processing_algs/gdal/rastermiscellaneous.html#viewshed) or [**Slope**](https://docs.qgis.org/latest/en/docs/user_manual/processing_algs/qgis/rasterterrainanalysis.html#slope) for terrain‑based stories.
:::
