...
There are many [datasets](Data_Sources.qmd) to choose from. Browse through online data sources and find some vector data and raster data that interest you.
...
Generate 1-3 maps covering a location of your choosing
